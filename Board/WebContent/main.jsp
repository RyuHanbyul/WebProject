			...
			<div id= "fluid" class="row-fluid">
				<ul id="seoul" class="thumbnails" >
					...
					<li class="span4" style="width:29.3%; margin:2%; text-align:center">
						<a href="#myModal${bau.getSubstance().getId()}" class="thumbnail"
							data-toggle="modal" class="btn btn-primary btn-large" style="width:450px; height:336px;"> <c:out
							...
							<div class="modal-header">
								...
								<div style="float: right;">
									...
									<c:if test="${bau.getUser().getPhotoUrl() != null }">
										<img src="./upload/${bau.getUser().getPhotoUrl()}" style="width: 40px; height: 40px;" escapeXml="false">
									</c:if>
								</div>
							</div>
						</div>
